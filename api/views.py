...
#User delete request
class UserRequestDeleteView(APIView):
    permission_classes = [IsAuthenticated]

    def delete(self, request, request_id):
        user = request.user
        try:
            user_request = Request.objects.get(id=request_id, employee=user)
        except Request.DoesNotExist:
            return Response(
                {'error': 'Request not found or you are not authorized to delete this request.'},
